...
public class GamePanel extends JPanel {
	...
	private class ButtonListener implements ActionListener {
		...
		/*This method handles what occurs when each button is pressed
		 * this class awaits for an event (a button press) to occur, and when
		 * an event occurs, this class checks which button the event is associated
		 * with. If it's a specific button, then the methods in the GameController are
		 * called. Then the panel is updated to reflect the changes to the data structures
		 */
